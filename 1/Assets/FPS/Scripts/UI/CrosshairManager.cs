...
namespace Unity.FPS.UI
{
    public class CrosshairManager : MonoBehaviour
    {
        ...
        PlayerWeaponsManagerBeta m_WeaponsManager;
        ...
        void Start()
        {
            m_WeaponsManager = GameObject.FindObjectOfType<PlayerWeaponsManagerBeta>();
            DebugUtility.HandleErrorIfNullFindObject<PlayerWeaponsManagerBeta, CrosshairManager>(m_WeaponsManager, this);

            OnWeaponChangedToCrossHair(m_WeaponsManager.GetActiveWeapon());

            //m_WeaponsManager.OnSwitchedToWeapon += OnWeaponChangedToCrossHair;
        }
        ...
        void OnWeaponChangedToCrossHair(WeaponController newWeapon)
        {
            if (newWeapon)
            {
