...
namespace Unity.FPS.UI
{
    public class NotificationHUDManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            PlayerWeaponsManagerBeta playerWeaponsManager = FindObjectOfType<PlayerWeaponsManagerBeta>();
            DebugUtility.HandleErrorIfNullFindObject<PlayerWeaponsManagerBeta, NotificationHUDManager>(playerWeaponsManager,
                this);
