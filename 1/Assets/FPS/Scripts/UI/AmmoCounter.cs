    ...
    public class AmmoCounter : MonoBehaviour
    {
        ...
        public void Initialize(WeaponController weapon, int weaponIndex)
        {
            ...
            if (!weapon.HasPhysicalBullets)
                BulletCounter.transform.parent.gameObject.SetActive(false);//如果没有PhysicalBullet,就不需要
            else
            ...
            DebugUtility.HandleErrorIfNullFindObject<PlayerWeaponsManagerBeta, AmmoCounter>(m_PlayerWeaponsManager, this);
        ...
        void Update()
        {
            ...
            ControlKeysRoot.SetActive(!isActiveWeapon); // the index doesn't show up in activeweapon
