...
namespace Unity.FPS.Gameplay
{
    public class ProjectileStandard : ProjectileBase
    {
        ...
        public float TrajectoryCorrectionDistance = 0;
        ...
        new void OnShoot()
        {
            ...
            PlayerWeaponsManagerBeta PlayerWeaponsManagerBeta = m_ProjectileBase.Owner.GetComponent<PlayerWeaponsManagerBeta>();
            if (PlayerWeaponsManagerBeta)
            {
                m_HasTrajectoryOverride = true;

                Vector3 cameraToMuzzle = (m_ProjectileBase.InitialPosition -
                                          PlayerWeaponsManagerBeta.GetActiveWeapon().WeaponMuzzle.transform.position);

                m_TrajectoryCorrectionVector = Vector3.ProjectOnPlane(-cameraToMuzzle,
                    PlayerWeaponsManagerBeta.GetActiveWeapon().WeaponMuzzle.transform.forward);
                ...
                if (Physics.Raycast(PlayerWeaponsManagerBeta.GetActiveWeapon().WeaponMuzzle.transform.position, cameraToMuzzle.normalized,
