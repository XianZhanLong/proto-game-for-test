...
namespace Unity.FPS.Game
{
    ...
    public class WeaponController : MonoBehaviour
    {
        ...
        public bool InputReload { get; set; } //Only be used when manually reloading weapon
        ...
        void ShootShell()
        {
            ...
            //not affected by any transformations of its previous parent.
        ...
        void UpdateAmmo()
        {
            ...
            else if (!AutomaticReload && InputReload  && m_LastTimeShot + AmmoReloadDelay < Time.time && m_CurrentAmmo < MaxAmmo && !IsCharging)
            {
                // reloads weapon over time
                m_CurrentAmmo += AmmoReloadRate * Time.deltaTime;
        ...
        bool TryShoot()
        {
            ////The current ammo(m_CurrentAmmo) is greater than or equal to 1f(indicating there is enough ammo to shoot).
        ...
        void HandleShoot()
        {
            ...
            Debug.Log("has " + bulletsPerShotFinal.ToString() + "been shot");
